...
namespace Jaxxa.EnhancedDevelopment.LaserDrill.Settings
{
    ...
    internal class ModSettings_LaserDrill : ModSettings
    {
        ...
        public void DoSettingsWindowContents(Rect canvas)
        {
            ...
            listing_Standard.Label("Scanning Days Required: " + RequiredScanningTimeDays);
            ...
            listing_Standard2.IntSetter(ref RequiredScanningTimeDays, 10, "Default");
            listing_Standard2.End();
            listing_Standard.GapLine();
            listing_Standard.Label("Allow Simultaneous Drilling:");
            listing_Standard.Gap();
            listing_Standard.CheckboxLabeled("Allow Simultaneous Drilling", ref AllowSimultaneousDrilling,
                "True if you want to allow Multiple Drills at once.");
            listing_Standard.GapLine();
